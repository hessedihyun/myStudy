...
public class TVUser01 {
	...
	public static void main(String[] args) {
		...
		// ** Test2. 객체지향
		// => 기본특징 : 캡슐화, 상속, 추상, 다형성(*) "캡.상.추.다!!!"
		// => 캡슐화 - 명령어: 정보를 은닉, 보호(private, protected 등 접근제어자)
		// => 상속  - 명령어: extends,
		// => 추상  - 명령어: 규칙성 후손 적용(abstract) 
		// => 다형성 적용
		...
		// main 매개변수가 null인 경우, args[0]의 값이 없기 때문에 
