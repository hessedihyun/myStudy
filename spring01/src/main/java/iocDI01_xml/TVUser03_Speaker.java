...
class SsTVs implements TV {
   private Speaker speaker = new Speaker(); // Speaker 인스턴스 생성
   public SsTVs() { System.out.println("~~ SsTVs Default 생성자 ~~"); } // SsTvs 인스턴스 생성
...
class LgTVs implements TV {
   private Speaker speaker; // speaker 타입
   private String color;
   private int price;
   
   public LgTVs() { System.out.println("~~ LgTVs Default 생성자 ~~"); }
   
   // 예시 new LgTVs(speak, "Grean", 12345000)
