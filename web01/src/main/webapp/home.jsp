...
<%-- <c:choose>
	...
	<c:otherwise>
		<h3>로그인 후 이용하세요~~</h3>
		&nbsp;<a href="/web01/servletTestForm/flowEx04_LoginForm_ssam.jsp">Login</a>&nbsp;
	</c:otherwise>
</c:choose> --%>
...
<c:if test="${empty sessionScope.loginName}">
	&nbsp;<a href="servletTestForm/flowEx04_LoginForm_ssam.jsp">Login</a>&nbsp;
	&nbsp;<a href="join_bymyself.jsp">Join</a>&nbsp;
</c:if><br>
