...
@WebServlet("/reqinfo")
public class Ex05_Requestioninfo extends HttpServlet {
	private static final long serialVersionUID = 1L;
    public Ex05_Requestioninfo() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("** 3) RealPath => "+request.getRealPath("/")); // 더이상 지원하지 않지만, 사용을 못하는 것은 아니다.
