...
=> Javascript 키 : 7fe45013c511952acefddd0bf18a2a13 (내 것)

=> http://apis.map.kakao.com/web/sample/ 
=> 객체및 사용법 안내 : https://apis.map.kakao.com/web/documentation/
-->	
<script type="text/javascript" 
	    src="//dapi.kakao.com/v2/maps/sdk.js?appkey=7fe45013c511952acefddd0bf18a2a13&libraries=services">
</script>	

</head>
<body>
<h2>Welcome! 러비하우스 </h2>
<font color="gray"><b>경기 군포시 수리산로 102 설악주공아파트, 대표번호: 010.8545.6861</b></font><br>
<br>
...
var address = '경기 군포시 수리산로 102 설악주공아파트 8단지' ;
var description = '러비하우스' ; // description: 설명,묘사
