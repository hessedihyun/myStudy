...
public class BoardSerivceImpl implements BoardService {
	...
	@Override
	public List<BoardDTO> selectList() {return dao.selectList();}
	@Override
	public BoardDTO selectOne(int seq) {return dao.selectOne(seq);}
	@Override
	public int insert(BoardDTO dto) {return dao.insert(dto);}
	@Override
