...
//  logger.info("Welcome home! 로그 메시지 Test -> locale is {}.", locale); // printf()와 비슷하다.
//    -> locale: ko_KR
...
//** Lombok 의 @Log4j Test (나중에 테스트 예정)
...
public class HomeController {
	...
	public String home(Locale locale, Model model) {
	    ...
	    //=> 로깅레벨 단계
	    //    TRACE -> DEBUG -> INFO -> WARN -> ERROR -> FATAL(치명적인)
		logger.error("** 로깅 레벨 Test 中 Error 단계 : name={}, age={}", name, age);
		logger.warn("** 로깅 레벨 Test 中 WARN 단계 : name={}, age={}", name, age);
		logger.info("** 로깅 레벨 Test 中 INFO 단계 : name={}, age={}", name, age);
		logger.debug("** 로깅 레벨 Test 中 DEBUG 단계 : name={}, age={}", name, age);
		logger.trace("** 로깅 레벨 Test 中 TRACE 단계 : name={}, age={}", name, age);
		*/
