   ...
   <!-- <option value="">조회수</option> -->
	...
	<form action="/" method="get">
      ...
      <!----------------------------------- -->
		...
		<input type="checkbox" name="check" class="clear check" value="0" ${ck0 ? 'checked':''}>미정&nbsp;
		...
		<input type="checkbox" name="check" class="clear check" value="7" ${ck7 ? 'checked':''}>칠면조<br>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="checkbox" name="check" class="clear check" value="8" ${ck8 ? 'checked':''}>8조&nbsp;
		<input type="checkbox" name="check" class="clear check" value="9" ${ck9 ? 'checked':''}>9조&nbsp;
		<input type="checkbox" name="check" class="clear check" value="13" ${ck13 ? 'checked':''}>13조&nbsp;
		<input type="checkbox" name="check" class="clear check" value="14" ${ck14 ? 'checked':''}>14조&nbsp;
		<input type="checkbox" name="check" class="clear check" value="15" ${ck15 ? 'checked':''}>15조&nbsp;
