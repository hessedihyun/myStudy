...
//** 방법
//=> 생성자를 private 으로 내부에서만 사용가능하도록 하고
...
public class Ex03_ServiceFactory {
	...
	// key : String 타입, [ex. "mlist.fo", "mdetail.fo"]
	// value : Ex04_Controller 공통 부모인 인터페이스 Ex04
	// mappings를 생성하는 곳은 생성자에서~!
	...
	public static Ex03_ServiceFactory getInstance() { return instance; } // 외부 컨트롤러는 getInstance만 하면 됨 (딱 1개만 생성해 공급하는 싱글톤 전개방식)
	
	//public static Ex03_ServiceFactory getInstance() { return new Ex03_ServiceFactory(); }
	//=> 싱글톤 적용되지 않음 : 메서드 호출시마다 생성됨
