...
<body>
<header>
<img alt="headImage" src="/resources/images/park.jpg" width="100" height="100">
<h3>** Hello! This is Merci's SpringBoot Mybatis **</h3>
</header>
<span id=span1>${serverTime}</span>
<div id="mainImg">
<img alt="mainImage" src="/resources/images/parkdance.gif" width="300" height="300"> <!-- 절대경로: '/'슬러시로 시작 -->
</div>
<div class="div1">
